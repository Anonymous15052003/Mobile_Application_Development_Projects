package com.reva.exp5;
import static com.reva.exp5.R.*;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ece.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(MainActivity.this, "welcome to ECE", Toast.LENGTH_SHORT).show();
                Intent i=new Intent(Intent.ACTION_VIEW);
        ...
        eee.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(MainActivity.this, "welcome to EEE", Toast.LENGTH_SHORT).show();
                Intent i = new Intent(Intent.ACTION_VIEW);
        ...
        cnit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(MainActivity.this, "welcome to CNIT", Toast.LENGTH_SHORT).show();
                Intent i=new Intent(Intent.ACTION_VIEW);
